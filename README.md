[![Build Status](https://travis-ci.org/IBM/max-tutorial-app-nodejs.svg?branch=master)](https://travis-ci.org/IBM/max-tutorial-app-nodejs)

# MAX Object Detector Web App (Lite) - NodeJS

A slimmed down version of the [MAX Object Detector Web App](https://github.com/IBM/MAX-Object-Detector-Web-App) for use in the MAX tutorial.
...
> This is the node version of this Web App, you can also check out the [Python version](https://github.com/IBM/max-tutorial-app-python)
